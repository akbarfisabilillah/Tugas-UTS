                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="<?= BASEURL; ?>/assets_web/img/c.png" alt="">
                                </a>
                            </div>
                            <p class="address_text">Badan Amil Zakat Universitas Cendekia Abditama adalah
                            </p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+0882 1096 0891</li>
                                <li><a href="#">akbar6@gmail@gmail.Com</a></li>
